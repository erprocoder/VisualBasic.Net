Module Module1
    Sub Main()
        ...
        Fields.Add(New Field() With {
            .Name = "des_system_lib",
            .DependsOn = Split("std synopsys std_cell_lib des_system_lib dw02 dw01 ramlib ieee", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw01",
            .DependsOn = Split("ieee dw01 dware gtech", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw02",
            .DependsOn = Split("ieee dw02 dware", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw03",
            .DependsOn = Split("std synopsys dware dw03 dw02 dw01 ieee gtech", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw04",
            .DependsOn = Split("dw04 ieee dw01 dware gtech", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw05",
            .DependsOn = Split("dw05 ieee dware", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw06",
            .DependsOn = Split("dw06 ieee dware", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dw07",
            .DependsOn = Split("ieee dware", " ")
        })
        Fields.Add(New Field() With {
            .Name = "dware",
            .DependsOn = Split("ieee dware", " ")
        ...
        Fields.Add(New Field() With {
            .Name = "gtech",
            .DependsOn = Split("ieee gtech", " ")
        })
        Fields.Add(New Field() With {
            .Name = "ramlib",
            .DependsOn = Split("std ieee", " ")
        })
        Fields.Add(New Field() With {
            .Name = "std_cell_lib",
            .DependsOn = Split("ieee std_cell_lib", " ")
        })
        Fields.Add(New Field() With {
            .Name = "synopsys"
        })
